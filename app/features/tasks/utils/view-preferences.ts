...
type UserPreferencesCookie = {
  ...
  defaultTasksView: TasksFiltersState['view'];
  defaultTasksOrder: TasksFiltersState['order'];
  defaultTasksScope: TasksFiltersState['scope'];
};
...
export function persistTasksViewPreferences(viewState: TasksFiltersState) {
